...
public class MapHistoryActivity extends FragmentActivity {
    ...
    private void setUpMap() {
        ...
        LatLng pinLatLng = new LatLng(mLatitude, mLongitude);
        mMap.clear();

        MarkerOptions markerOptions = new MarkerOptions()
                .position(pinLatLng)
                .title(getString(R.string.your_car))
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.parked_pin));
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(pinLatLng, 15));
